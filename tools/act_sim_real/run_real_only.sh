#!/usr/bin/env bash
# Reproducible Task_000458 real-only ACT workflow. Run from any directory.
set -euo pipefail
...
DATASET_ROOT="$WORKSPACE/dataset/robotis/task_000458_peanut_mix_real_only_act_v30"
DATASET_REPO_ID="robotis/task_000458_peanut_mix_real_only_act_v30"
...
ACT_JOB_NAME="${ACT_JOB_NAME:-task_000458_peanut_mix_real_only_act}"
...
CONTAINER_DATASET_ROOT="$CONTAINER_WORKSPACE/dataset/robotis/task_000458_peanut_mix_real_only_act_v30"
...
build-dataset Convert all real-only episodes into one 224x224, 10 Hz LeRobot v3 dataset.
